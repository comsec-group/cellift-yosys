...
private:
	...
	void insert_demux_cell() {
		...
		if (module->get_bool_attribute(insert_demux_cell_attribute_name))
			return;

		log("Inserting demux cell...\n");
...
struct InsertDemuxCellPass : public Pass {
	InsertDemuxCellPass() : Pass("insert_demux_cell", "Add a demux cell in the design top module. This is a pass dedicated to cell unit testing.") {}
